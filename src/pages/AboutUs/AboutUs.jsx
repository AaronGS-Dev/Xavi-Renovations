  ...
  return (
    <div className='h-full w-full flex items-center justify-center'>
        <div className='h-[90%] w-[75%] flex flex-col-reverse xl:flex-row items-center gap-8'>
            <div className='h-[50%] xl:h-[90%] w-[95%] xl:w-[60%] bg-[url("https://res.cloudinary.com/dytjoh7oh/image/upload/v1718290911/XaviRenovaties/Public/Home4_wtyqzj.png")] bg-contain bg-no-repeat bg-center xl:bg-cover xl:bg-center flex justify-center items-center'>
            </div>
